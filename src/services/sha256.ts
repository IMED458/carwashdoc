/**
 * SHA-256 — იყენებს crypto.subtle-ს (HTTPS/localhost), თუ ის მიუწვდომელია
 * (მაგ. HTTP-ზე), გადადის pure-JS იმპლემენტაციაზე. ორივე იძლევა იდენტურ შედეგს.
 */
...
/** SHA-256 hex. input — ტექსტი ან bytes. */
