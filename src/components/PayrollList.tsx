  ...
  return (
    <div className="space-y-6" id="payroll-section-root">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm text-xs">
          <span className="text-slate-400 block font-medium">ჯამური დარიცხული (Gross)</span>
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm text-xs">
          <span className="text-slate-400 block font-medium">გადახდილი სუფთა ხელფასი (Net)</span>
          ...
          <table className="w-full text-left text-xs border-collapse">
            <thead>
              <tr className="border-b border-slate-100 bg-slate-50 text-slate-500 font-semibold uppercase tracking-wider">
                ...
                <th className="p-4 text-right">დარიცხული (Gross)</th>
                <th className="p-4 text-right">საშემოსავლო (20%)</th>
                <th className="p-4 text-right">ხელზე (Net)</th>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 bg-indigo-50/20 p-4 rounded-xl border border-indigo-100/50 space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-xs">
                    <div>
                      <label className="block text-[10px] text-slate-500 font-semibold mb-1">დარიცხული (Gross) *</label>
                      <input 
                        type="number" 
                        required
                    ...
                    <div>
                      <label className="block text-[10px] text-indigo-900 font-semibold mb-1">ხელზე ასაღები (Net)</label>
                      <input 
                        type="number" 
                        disabled
                        value={netAmount || ''}
