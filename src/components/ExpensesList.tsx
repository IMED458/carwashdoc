...
export default function ExpensesList({
  ...
  const handleUploadDocumentSubmit = (e: React.FormEvent) => {
    ...
    const simulatedSize = Math.floor(Math.random() * 800) + 150 + ' KB';
          ...
          <div className="bg-white rounded-3xl max-w-4xl w-full border border-slate-100 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 max-h-[90%] flex flex-col">
            ...
            <div className="p-6 overflow-y-auto flex-1">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-xs">
                        <div>
                          ...
                          <span className="font-bold text-indigo-600">{selectedExpense.status}</span>
                        </div>
                        <div>
                  ...
                  {currentUserRole !== 'viewer' && (
                    <form onSubmit={handleUploadDocumentSubmit} className="bg-indigo-50/20 p-5 rounded-2xl border border-indigo-100/50 space-y-4">
                      <span className="text-xs font-bold text-indigo-900 block flex items-center gap-1">
                        ...
                        ახალი დოკუმენტის მიბმა (სიმულირებული ატვირთვა)
                      </span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="md:col-span-2">
                          <label className="block text-[10px] font-bold text-slate-500 mb-1">ფაილის სახელი</label>
                          <input 
                            type="text" 
                            placeholder="მაგ: invoice_pumps_final.pdf"
                            required
                            value={docFileName}
                        ...
                        <div key={p.id} className="p-4 bg-slate-50 rounded-xl border border-slate-100 text-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-2 text-[10px] text-slate-400 font-mono">
                              ...
                              <span>•</span>
                              <span>მეთოდი: <strong className="text-slate-500 uppercase">{p.paymentMethod}</strong></span>
                              <span>•</span>
              ...
              {activeDetailTab === 'history' && (
                <div className="space-y-4">
                  <span className="text-xs font-bold text-slate-600 block">სტატუსებისა და ცვლილებების ისტორია (Audit History)</span>
                      ...
                      <div key={h.id} className="relative">
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center gap-1.5 text-slate-500">
                            ...
                            <span className="font-semibold text-slate-600">{h.fromStatus}</span>
